...
export function addPayment(token) {
  return function(dispatch) {
    axios.post("/api/stripe/card", { token }).then(res => {
      console.log(res);
      dispatch({ type: "GOT_CARD", payload: res });
    });
  };
}

export function addPayout(token) {
  console.log("here");
  return function(dispatch) {
    axios.post("/api/stripe/bank", { token }).then(res => {
      console.log(res);
      dispatch({ type: "GOT_BANK", payload: res });
    });
  };
}
...
export function addGoogle() {
  return function(dispatch) {
    axios
      .post("/api/services/googleAuth", { url: appUrl })
      .then(res => {
        console.log(res);
...
export function getGoogleToken(code) {
  return function(dispatch) {
    axios
      .post("/api/services/googleToken", { code: code, url: appUrl })
      .then(res => {
        console.log(res);
        let data = res.data;
        let body = {
